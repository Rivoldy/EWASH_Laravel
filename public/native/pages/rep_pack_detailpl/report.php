...
$pdf->SetFont('helvetica', 'B', 12);
$pdf->Cell(95, 5, 'Detail Packing List', 0, 1, 'C');
...
$pdf->Cell(30, 8, 'GW', 1, 0);
$pdf->Cell(30, 8, 'NW', 1, 0);
$pdf->Cell(30, 8, 'QTY', 1, 1);

$q = mysqli_query($conn, "SELECT * from t_scale where kp='$kp' $ftgl");
while ($dt = mysqli_fetch_assoc($q)) {
	...
	$pdf->Cell(30, 8, number_format($dt['gw'], 3), 1, 0, 'C');
	$pdf->Cell(30, 8, number_format($dt['nw'], 3), 1, 0, 'C');
