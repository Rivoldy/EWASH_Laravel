    ...
    <div class="card pt-3 border-danger col-sm-12">
      ...
      <table style="font-size: 14pt" class="bold">
        ...
        <tr>
          ...
          <td>
            <?php
            $q2 = mysqli_query($conn, "SELECT SUM(qty) AS qty FROM t_bag WHERE style = '{$r['style']}' AND kp = '{$r['kp']}'");
        ...
        <tr>
          ...
          <td id="pcsloaded">
            <?php
            $q2 = mysqli_query($conn, "SELECT SUM(qty) AS qty FROM t_bag WHERE pl_id = '$id'");
        ...
        <tr>
          ...
          <td>
            <?php
            $q2 = mysqli_query($conn, "SELECT * FROM t_bag WHERE style = '{$r['style']}' AND kp = '{$r['kp']}' GROUP BY bid");
            if (mysqli_num_rows($q2) == 0) {
              $bl = 0;
            } else {
        ...
        <tr>
          ...
          <td id="bagloaded">
            <?php
            $q2 = mysqli_query($conn, "SELECT * FROM t_bag WHERE style = '{$r['style']}' AND kp = '{$r['kp']}' AND pl_id = '$id' GROUP BY bid");
            if (mysqli_num_rows($q2) == 0) {
              $bl = 0;
            } else {
              $bl = mysqli_num_rows($q2);
