  ...
  <div class="container-fluid animatedParent animateOnce pt-4">
    <div class="card pt-3 border-danger col-sm-12">
      <div class="animated fadeInUpShort d-flex justify-content-center">
        <h2 class="text-center">Unpack Carton Finish Goods</h2>
      </div>
      ...
      <div class="card-body pl-3">
        ...
        <input type="text" name="cartonid" style="height:0px;width:0px;border:none" autocomplete="off" autofocus onblur="$(this).focus()">
      </div>
    </div>
    <div>
      <audio id="audiocom">
