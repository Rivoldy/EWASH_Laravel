<?php
require_once('public/native/proses/conn.php');
            ...
            <div class="col-12">
              <div class="card">
                <div class="card-header d-flex">
                  ...
                  <form action="{{asset('native/proses/synckp.php')}}" method="post">
                              ...
                              <div class="modal fade" id="e<?= $d['kp'] ?>" tabindex="-1">
                                <div class="modal-dialog modal-lg">
                                  <div class="modal-content">
                                    ...
                                    <form action="{{asset('native/proses/allocate.php')}}" method="POST">
