            ...
            <div class="col-12">
                ...
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">
                           <i class="fa-regular fa-newspaper text-success"></i> Report Loaded PackingList
                        </h3>
...
<script>
    function showrep() {
      ...
      if (kp != '' && tgl != '') {
        ...
        $.ajax({
          url: '{{ asset("native/pages/rep_afterwash_actpl/ajax/datarep.php") }}',
          method: 'post',
          data: {
            kp,
            tgl
    ...
    function getdata(id) {
      ...
      $.ajax({
        url: '{{ asset("native/pages/rep_afterwash_actpl/ajax/getdata.php") }}',
        method: 'post',
        data: {
          style,
          kp
