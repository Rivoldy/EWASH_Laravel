<aside class="main-sidebar sidebar-dark-primary bg-black elevation-4">
    ...
    <div class="sidebar">
        ...
        <div class="user-panel mt-3 pb-3 mb-2 d-flex">
            <div class="image">
                <img src="{{asset('native/dist/img/fav.png')}}" alt="EWASH logo" height="50" width="50" />
            </div>
            <div class="info">
        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                ...
                <li class="nav-item">
                  <a href="#" class="nav-link">
                      ...
                      <li class="nav-item sidebar-menu-item">
                        ...
                        <a href="/SendOutRFID" class="sendrfid nav-link">
                          <i class="fal fa-truck-container nav-icon text-warning"></i>
                          <p>Send Out RFID</p>
                        </a>
                        @endif
              ...
              <li class="nav-item" id="navafterwashrfid">
                ...
                @endif
                @endforeach
                <!-- Add other administrator menu items here -->
            </ul>
        </nav>
    </div>
    <!-- /.sidebar -->
